...
public class TypeName {
  ...
  /**
   * Returns a boxed type like {@code java.lang.Integer} if this is a primitive type like {@code
   * int} or void. Returns this type if boxing doesn't apply.
   */
  public TypeName box() {
  ...
  /**
   * Returns a primitive type like {@code int} if this is a boxed type like {@code
   * java.lang.Integer}, or void if this is {@link java.lang.Void}. Returns this type if it is
   * already unboxed.
   *
